...
# Log levels and their corresponding values
log_levels = {
    "TRACE": 0,
    "DEBUG": 1,
    "INFO ": 2,
...
class TextLineNumbers(tk.Canvas):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.textwidget: tk.Text = None

    def attach(self, text_widget: tk.Text):
        """Attach the line numbers to a text widget."""
...
class CustomText(tk.Text):
    ...
    def _proxy(self, *args):
        """Proxy for the underlying widget."""
...
class PlaceholderEntry(tk.Entry):
    """Entry widget with a placeholder text."""
    ...
    def handle_ctrl_backspace(self, event: tk.Event):
        """Handle the Ctrl+Backspace event."""
...
class OptionsFrame(tk.Frame):
    """Frame for search and filter options."""
...
class GlobalSearchFrame(tk.Frame):
    ...
    def apply_search_mode(self, *args):
        """Apply the selected search mode."""
        self.console.set_filter(global_search_mode=self.search_mode_var.get())

    def inject_console(self, console):
        """Inject the console object into the global search frame."""
        self.console = console

    def create_widgets(self):
        """Pack the widgets in the global search frame."""
...
class Console(tk.Frame):
    ...
    def _on_change(self, event: tk.Event):
        """Handle the change event."""
        self.linenumbers.redraw()

    def create_widgets(self):
        """Pack the widgets in the console frame."""
    ...
    def filter_log(self, log: Log):
        """Filter a log based on the current filters."""
    ...
    def update_text_widget(self):
        """Update the text widget with the filtered logs."""
    ...
    def search_text(self):
        """Search for the global search string in the text widget."""
    ...
    def prepare_occurrence_navigation(self):
        """Prepare for navigating to the next/previous occurrence."""
    ...
    def next_occurrence(self):
        """Navigate to the next occurrence of the search string."""
    ...
    def previous_occurrence(self):
        """Navigate to the previous occurrence of the search string."""
        current_tags, cursor_position = self.prepare_occurrence_navigation()
        if not current_tags or not cursor_position:
            return
...
class SpecificSearchFrame(tk.Frame):
    ...
    def inject_console(self, console):
        """Inject the console object into the specific search frame."""
        self.console = console
    ...
    def create_widgets(self):
        """Pack the widgets in the specific search frame."""
...
class ExportMenuBar(tk.Menu):
    ...
    @staticmethod
    def export(log_type: str, logs: List[Log]):
        """Export logs to a file."""
        file_path = filedialog.asksaveasfilename(
            defaultextension=".log",
            filetypes=[("Log files", "*.log"), ("All files", "*.*")],
            initialfile=f"Balatro-{log_type}-{datetime.now().strftime('%Y-%m-%d_%H-%M-%S')}.log"
        )
        if file_path:
    ...
    def export_all_logs(self):
        ...
        self.export("AllLogs", self.console.all_logs)

    def export_filtered_logs(self):
        """Export the filtered logs to a file."""
        self.export("FilteredLogs", self.console.shown_logs)


class MainWindow(tk.Tk):
    """Main window for the debug console."""
...
def listen_for_clients(console: Console):
    """Listen for incoming connections and spawn a new thread to handle each client."""
